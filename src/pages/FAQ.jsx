    ...
    const faqStudent_ContactAndTrust = [
        {
            ...
            content: "เมื่อคุณเลือกครูที่สนใจแล้ว คุณสามารถส่งคำขอเพื่อให้ครูติดต่อกลับได้ โดยครูจะได้รับข้อมูลการติดต่อของคุณ",
            defaultExpanded: false
        },
        {
    ...
    return (
        ...
        <div className="max-w-4xl mx-auto md:px-4 py-8">
            <motion.h1 
                ...
                delay={0.2}
                className="text-3xl font-bold mb-6">คำถามที่พบบ่อย (FAQ) – ว่ายน้ำ.com</motion.h1>
