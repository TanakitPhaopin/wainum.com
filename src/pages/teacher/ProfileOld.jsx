...
import { upsertTeacherProfileField } from '../../services/teacher';
...
export default function Profile() {
  ...
  const handleUpsert = async (field, e) => {
  ...
  // // Validate any change in field
  // const isChanged = (fieldName, fieldValue) => {
  //   switch (fieldName) {
  //     case 'is_public':
  //       return is_public !== fieldValue;
  //     case 'profile_picture':
  //       return profile_picture !== fieldValue;
  //     case 'display_name':
  //       return display_name !== fieldValue;
  //     case 'bio':
  //       return bio !== fieldValue;
  //     case 'contacts':
  //       return JSON.stringify(contacts) !== JSON.stringify(fieldValue);
  //     case 'selectedProvinces':
  //       return JSON.stringify(selectedProvinces) !== JSON.stringify(fieldValue);
  //     case 'about_location':
  //       return about_location !== fieldValue;
  //     case 'can_travel':
  //       return can_travel !== fieldValue;
  //     case 'travel_note':
  //       return travel_note !== fieldValue;
  //     case 'can_online':
  //       return can_online !== fieldValue;
  //     case 'selectedLevel':
  //       return JSON.stringify(selectedLevel) !== JSON.stringify(fieldValue);
  //     case 'about_lesson':
  //       return about_lesson !== fieldValue;
  //     case 'hourly_rate':
  //       return hourly_rate !== fieldValue;
  //     case 'lesson_package':
  //       return lesson_package !== fieldValue;
  //     case 'experience':
  //       return experience !== fieldValue;
  //     case 'qualification':
  //       return qualification !== fieldValue;
  //     default:
  //       console.warn(`Unhandled field: ${fieldName}`);
  //       return false; // Default to false if field is unhandled
  //   }
  // };
    ...
    >
      <div className='flex flex-row justify-between items-center'>
        ...
        <MyTextField
          ...
          showCounter={true}
          required={true}
          onBlur={(e) => handleUpsert('display_name',e)}
        />        
        <MyTextField
          id={'แนะนำตัว'}
          label="แนะนำตัว"
