...
export default function Home({openSignupClick}) {
    ...
    return (
        <>
        <Seo
            title="ว่ายน้ำ.com | ค้นหาครูสอนว่ายน้ำทั่วไทย"
            description="ว่ายน้ำ.com แหล่งรวมครูสอนว่ายน้ำทั่วไทย ค้นหา เปรียบเทียบราคา และอ่านรีวิว ครูสอนว่ายน้ำใกล้คุณ"
            canonical="https://xn--q3cro8bc2kk6a.com/"
        />
        <div className="h-full w-full mb-8">
            <div className="flex flex-col items-center justify-center py-0 lg:py-8">
                <motion.h1 
                    ...
                    className="text-4xl lg:text-5xl 2xl:text-6xl text-black leading-snug sm:leading-tight">ว่ายน้ำ.com | ค้นหา<span className="font-semibold">ครูสอนว่ายน้ำ</span>ทั่วไทย
                </motion.h1>
                <motion.div 
